              ...
              <div className="bg-gray-800 p-4 rounded-lg">
                <div className="grid grid-cols-1 gap-4 mt-4">
                  {round.map((match, matchIndex) => {
                    ...
                    const homeTeamImageUrl = sanityTeamData.find((e) => e.teamName === homeTeamName)?.teamImage.asset
                      ._ref
                    const awayTeamImageUrl = sanityTeamData.find((e) => e.teamName === awayTeamName)?.teamImage.asset
                      ._ref
                    ...
                    const homeTeamHasLogs =
                      homeTeamMatchResults?.warcraft_logs_report &&
                      homeTeamMatchResults?.warcraft_logs_report.length > 0

                    const awayTeamHasLogs =
                      awayTeamMatchResults?.warcraft_logs_report &&
                      awayTeamMatchResults?.warcraft_logs_report.length > 0
