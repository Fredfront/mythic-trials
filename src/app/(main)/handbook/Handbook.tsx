  ...
  const sections = [
    {
      title: 'Opprett lag',
      ingress:
        'For å kunne delta i turneringen må du først logge inn, deretter opprette et lag ved å trykke på påmeldings knappen.',
      content:
        'Du må logge inn med din discord-konto for å kunne delta i turneringen. Deretter kan du opprette et lag ved å trykke på påmeldingsknappen.',
    },
    {
      title: 'Endre lag',
    ...
    },
    {
      ...
      content:
        'Det er viktig at begge lag legger til resultatet av kampen etter kampen er ferdig. Begge lag må godkjenne resultatet. Om et lag ikke legger til resultatet, vil laget som har lagt inn resultat kunne erklære seier 24t etter kampen.',
    ...
    },
    {
      ...
      content:
        'Det er mulig å foreslå en ny tid for kampen om den oppsatte tiden ikke passer. Foreslå en ny tid for kampen og vent på svar fra motstander.',
    ...
    },
    {
      ...
      content:
        'Har du mottatt en forespørsel om å endre kampplan? Godta eller avslå forespørselen. Motstander vil bli varslet om du godtar eller avslår forespørselen.',
...

    {
      title: 'Discord',
      content:
        'Meste parten av kommunikasjonen vil foregå på Discord. Her kan du kommunisere med motstandere og arrangører, og få notifaksjoner om motstander har foreslått en ny tid for kampen.',
      ingress:
        'Turneringen har en egen Discord server for påmeldte lag. Her kan du kommunisere med motstandere og arrangører, og få notifaksjoner om motstander har foreslått en ny tid for kampen.',
    },
    {
          ...
          <AccordionItem value={`item-${index}`} key={index}>
            ...
            <AccordionContent className="p-4  rounded-lg">
              <div>
                ...
                {section.videoSrc && (
                  <div className="relative w-auto h-48 mt-4 rounded-lg overflow-hidden">
                ...
                {section.link && (
                  <Link href={section.link}>
                    <Button className="bg-white mt-4 text-black">{section.buttonLabel}</Button>
                  </Link>
                )}
              </div>
            </AccordionContent>
