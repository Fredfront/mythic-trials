...
async function fixMatch3(contact_person: string, round: number) {
  await supabase.from('match_results').update({ match_3: null }).eq('contact_person', contact_person).eq('round', round)
}
