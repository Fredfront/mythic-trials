...
export function DraggableRoundCarousel({ roundsFromDB }: { roundsFromDB: RoundType[] }) {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <Button
        className={`absolute left-2 top-1/2 -translate-y-1/2 z-20 transition-opacity duration-300 ease-in-out bg-gray-800 ${
      ...
      <Button
        className={`absolute right-2 top-1/2 -translate-y-1/2 z-20 transition-opacity duration-300 ease-in-out bg-gray-800 ${
